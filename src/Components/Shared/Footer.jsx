...
const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: FaGithub,
      href: "https://github.com/whahidul12",
      label: "GitHub",
  ...
  const legalLinks = [
    ...
    { name: "Cookie Policy", href: "/cokies" },
  ];
  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-300">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute right-20 bottom-20 h-32 w-32 rounded-full bg-gradient-to-r from-green-500/10 to-teal-500/10 blur-3xl"></div>
      ...
      <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-4">
            ...
            >
              ...
              >
                ...
                <img
                  src={logo}
                  alt="Crazy Contest Logo"
                  className="-ml-2 w-10"
                />
              </Link>

              <p className="mb-6 leading-relaxed text-gray-400">
                The world's leading platform for creative contests. Join
                thousands of creators competing for amazing prizes and building
                their careers.
              </p>
        ...
        <div className="border-t border-gray-800">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              >
                &copy; {currentYear} Crazy Contest. All rights reserved. Made
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="bg-secondary-o flex h-10 w-10 cursor-pointer items-center justify-center rounded-full text-white transition-all duration-300 hover:shadow-lg"
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="border-t border-gray-800 bg-gradient-to-r from-green-900/20 to-gray-900/20"
        >
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Get notified about new contests and opportunities
                </p>
              </div>
              <a
                href="#newsletter"
                className="bg-secondary-o rounded-lg px-6 py-2 font-semibold text-white transition-all duration-300 hover:shadow-lg"
              >
                Subscribe Now
              </a>
            </div>
